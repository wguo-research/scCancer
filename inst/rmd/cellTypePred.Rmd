...
We train a one-class logistic regression (OCLR) model to annotate cancer micro-environmental cell type. 
...
Here is the t-SNE plot colored by predicted cell types.

```{r cellTypePlot, echo=F, message=F, warning=F, dpi=500, fig.width=5, fig.height=4, fig.align="center", out.width='80%'}
...
```{r barPlot, echo=F, message=F, warning=F, dpi=300, fig.width=6, fig.height=3, fig.align="center", out.width='80%'}
