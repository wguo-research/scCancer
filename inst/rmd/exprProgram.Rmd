...
Here, we use non-negative matrix factorization (NMF) to identify cells' expression programs.
...
```{r exprProgramplot, echo=F, message=F, warning=F, dpi=800, fig.width=10, fig.height=results$exprProgPlot.height}
