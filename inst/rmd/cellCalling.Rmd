...
cat("* Using the supplied cell calling results(fitered data), `", results$nList[2], "` cells are identified (min.nUMI = `", results$min.nUMI, "`).\n", sep = "")
```
...
* Following are two figures showing the distribution of `nUMI` for cells and empty droplets identified. 
