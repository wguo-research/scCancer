...
Here is the t-SNE plot colored by estimated stemness scores.

```{r stemnessPlot, echo=F, message=F, warning=F, dpi=500, fig.width=5, fig.height=5.2, fig.align="center", out.width='60%'}
