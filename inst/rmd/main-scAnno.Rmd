...
In order to perform dimensional reduction, cluster and visualization, we do as following based on some functions of the R package [`Seurat V3`](https://satijalab.org/seurat/).
